            ...
            <table class="table table-striped ">
                ...
                <c:forEach items="${pageInfo.list}" var="list">
                    <tr>
                        ...
                        <c:choose>
                            <c:when test="${list.disabled eq 0 }">
                                <td>正常</td>
                            </c:when>
                            <c:otherwise>
                                <td>已注销</td>
                ...
                <div class="col-md-6">
                    <nav aria-label="Page navigation" class="pull-right">
                        <ul class="pagination pagination-sm" style="margin: 0px;">
                            <li>
                                <a href="${pageContext.request.contextPath}/user/userList?pageIndex=1&pageSize">首页</a>
                            </li>
                            <%--第一页时不可点击上一页--%>
                            ...
                            <c:if test="${pageInfo.pageNum!=1}">
                                <li>
                                    <a href="${pageContext.request.contextPath}/user/userList?pageIndex=${pageInfo.pageNum-1}&pageSize"
                            ...
                            <c:forEach items="${pageInfo.navigatepageNums}" step="1" var="itemPage">
                                ...
                                <c:if test="${pageInfo.pageNum == itemPage}">
                                    <li class="active">
                                        <a
                                                href="${pageContext.request.contextPath}/user/userList?pageIndex=${itemPage}&pageSize">${itemPage}</a>
                                    </li>
                                </c:if>
                                <%--非当前页 不激活--%>
                                <c:if test="${pageInfo.pageNum != itemPage}">
                            ...
                            <li><a
                                    href="${pageContext.request.contextPath}/user/userList?pageIndex=${pageInfo.pages}&pageSize">尾页</a>
                            </li>
                        </ul>
                    </nav>
                </div>
    ...
    $(function () {
        ...
        $(".prePage").click(function () {
            if (curPage > 1) {
                ...
                $(this).attr("href", "${pageContext.request.contextPath}/user/userList?pageIndex=" + pageNo + "&pageSize");
            }
        });
        //下一页

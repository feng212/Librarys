            ...
            <div class="panel-heading" style="width: 1050px">
                ...
                <div class="col-6" style="text-align: right">
                    <c:if test="${sessionScope.user.isAdmin eq 1}">
                        <button type="button" class="btn btn-primary"><a href="/books/book">添加</a></button>
                    </c:if></div>
            </div>
                            ...
                            <div class="btn-group">
                                <c:choose>
                                    <c:when test="${sessionScope.user.isAdmin eq 0 }">
                                        <a href="/borrow/borrowInsert?bookId=${list.bookId}"
                                           class="btn btn-default">出借</a>
                                    </c:when>
                                    <c:otherwise>
                                        <a href="/books/bookUpIndex?bookId=${list.bookId}"
                                           class="btn btn-default">修改</a>
                                        <a href="/books/deleteBook?bookId=${list.bookId}" class="btn btn-danger">删除</a>
                                    </c:otherwise>
                                </c:choose>
                ...
                <div class="col-md-6">
                    <nav aria-label="Page navigation" class="pull-right">
                        <ul class="pagination pagination-sm" style="margin: 0px;">
                            <li>
                                <a href="${pageContext.request.contextPath}/books/bookPage?pageIndex=1&pageSize">首页</a>
                            </li>
                            <%--第一页时不可点击上一页--%>

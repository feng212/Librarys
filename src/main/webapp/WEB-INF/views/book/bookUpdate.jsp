...
<div style="margin:10px 0; font:normal 14px/24px 'MicroSoft YaHei'; ">
    <div class="row">
        <div class="col-sm-10"></div>
        <div class="col-sm-2">
            <button type="button" class="btn btn-info"><a href="/books/bookIndex">返回</a></button>
        </div>
    </div>
    <div class="container" style="margin: 40px 0">
        <div class="row clearfix">
            <div style="height: 500px;margin-left: 50px; width: 950px;">
                <form class="form-horizontal" role="form" action="bookUpdate" method="post">
                    <div class="form-group">
                        <label for="bookId" class="col-sm-2 control-label">图书编号</label>
                        <div class="col-sm-10">
                            <input type="text" required="required" readonly="readonly" class="form-control" id="bookId"
                                   name="bookId"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" required="required" class="form-control" id="bookName" name="bookName"
...
<script type="text/javascript">
    ...
    if (results === "bookIdRepeat") {
        $('.alert').html('修改失败').addClass('alert-success').show().delay(2500).fadeOut();
    }
    console.log(results)

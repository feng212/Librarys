    ...
    <div class="container" style="margin: 40px 0">
        <div class="row clearfix">
            <div style="height: 500px;margin-left: 50px; width: 950px;">
                <form class="form-horizontal" role="form" action="bookInsert" method="post">
                    <div class="form-group">
                        <label for="bookId" class="col-sm-2 control-label">图书编号</label>
                        <div class="col-sm-10">
                            <input type="text" required="required" class="form-control" id="bookId" name="bookId"
                                   placeholder="图书编号">
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
        ...
        if (results==="bookIdRepeat") {
            $('.alert').html('编号已存在').addClass('alert-success').show().delay(2500).fadeOut();
        }
        console.log(results)

                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="bookName" name="bookName"
                                   placeholder="图书名" value="${books.bookName}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="bookAuthor" name="bookAuthor"
                                   placeholder="图书作者" value="=${books.bookAuthor}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="press" name="press"
                                   placeholder="出版社" value="${books.press}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control" id="publicationTime" name="publicationTime"
                                   placeholder="出版时间" value="${books.publicationTime}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="bookBrief" name="bookBrief"
                                   placeholder="图书简介信息" value="${books.bookBrief}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="price" name="price"
                                   placeholder="单价" value="${books.price}">
                        </div>
                    </div>

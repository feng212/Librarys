            ...
            <table class="table table-striped ">
                ...
                <c:forEach items="${pageInfo.list}" var="list">
                    <tr>
                        ...
                        <td>${list.bookName}</td>
                        <td>${list.userName}</td>
                        <td>${list.borrowTimes}</td>
                        <td>${list.returnTimes}</td>
                        <td>
                                ${list.borrowState}
                        </td>
                        <td>
                            <div class="btn-group">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <c:if test="${ empty list.returnTimes}">
                                            <a href="/borrow/borrowReturn?borrowId=${list.borrowId}&bookId=${list.bookId}"
                                               class="btn btn-default">归还</a>
                                        </c:if>
                                    </c:otherwise>
                                </c:choose>
                ...
                <div class="col-md-6">
                    <nav aria-label="Page navigation" class="pull-right">
                        <ul class="pagination pagination-sm" style="margin: 0px;">
                            <li>
                                <a href="${pageContext.request.contextPath}/borrow/borrowIndex?pageIndex=1&pageSize">首页</a>
                            </li>
                            <%--第一页时不可点击上一页--%>
                            ...
                            <c:if test="${pageInfo.pageNum!=1}">
                                <li>
                                    <a href="${pageContext.request.contextPath}/borrow/borrowIndex?pageIndex=${pageInfo.pageNum-1}&pageSize"
                            ...
                            <c:forEach items="${pageInfo.navigatepageNums}" step="1" var="itemPage">
                                ...
                                <c:if test="${pageInfo.pageNum == itemPage}">
                                    <li class="active">
                                        <a
                                                href="${pageContext.request.contextPath}/borrow/borrowIndex?pageIndex=${itemPage}&pageSize">${itemPage}</a>
                                    </li>
                                </c:if>
                                <%--非当前页 不激活--%>
                                <c:if test="${pageInfo.pageNum != itemPage}">
                            ...
                            <li><a
                                    href="${pageContext.request.contextPath}/borrow/borrowIndex?pageIndex=${pageInfo.pages}&pageSize">尾页</a>
                            </li>
                        </ul>
                    </nav>
                </div>
    ...
    $(function () {
        ...
        $(".prePage").click(function () {
            if (curPage > 1) {
                ...
                $(this).attr("href", "${pageContext.request.contextPath}/borrow/borrowIndex?pageIndex=" + pageNo + "&pageSize");
            }
        });
        //下一页
